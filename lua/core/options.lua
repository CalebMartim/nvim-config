...
-- Case-insensitive searching unless there's a capital
-- (that second part doesn't seem to work lol)
...
vim.o.smartindent = true -- Make indenting smarter again (not sure what that means)
...
--vim.o.whichwrap = 'bs<>[]hl' -- Which "horizontal" keys are allowed to travel to press/next line (default: 'b,s')
